<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="services.aspx.cs" Inherits="CanCat_.services" %>
                ...
                <div class="col-md-4 d-flex align-self-stretch px-4 ftco-animate">
                    <div class="d-block services text-center">
                        ...
                        <div class="media-body">
                            ...
                            <p>CanCat offer a recreational service for pets, after a cosmetic service there is no additional cost, the individual price of the service is 5$</p>
                ...
                <div class="col-md-4 d-flex align-self-stretch px-4 ftco-animate">
                    <div class="d-block services text-center">
                        ...
                        <div class="media-body">
                            ...
                            <p>CanCat offer basic pet care services, if it is not possible to take care of your pet we will provide you with the contact information of an affiliated veterinarian..</p>
                ...
                <div class="col-md-4 d-flex align-self-stretch px-4 ftco-animate">
                    <div class="d-block services text-center">
                        ...
                        <div class="media-body">
                            ...
                            <p>CanCat provide cosmetic care services for pets, including, bathing, nail trimming, hair cutting, dental grooming and deworming.</p>
                            <a href="pricing.aspx" class="btn-custom d-flex align-items-center justify-content-center"><span class="fa fa-chevron-right"></span><i class="sr-only">Leer Más</i></a>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-4 ftco-animate">
                    <div class="block-7">
                        ...
                        <div class="text-center p-4">
                            ...
                            <span class="price"><sup>$</sup> <span class="number">30</span> <sub>/mos</sub></span>

                            <ul class="pricing-text mb-5">
                                <li><span class="fa fa-check mr-2"></span>3 spa para mascota</li>
                                <li><span class="fa fa-check mr-2"></span>3 revisiones medicas</li>
                                <li><span class="fa fa-check mr-2"></span>3 paseos post servicio</li>
                            </ul>

                            <a href="pricing.aspx" class="btn btn-primary d-block px-2 py-3">Empezar</a>
                        </div>
                    </div>
                </div>
                <div class="col-md-4 ftco-animate">
                    <div class="block-7">
                        ...
                        <div class="text-center p-4">
                            ...
                            <span class="price"><sup>$</sup> <span class="number">60</span> <sub>/mos</sub></span>

                            <ul class="pricing-text mb-5">
                                <li><span class="fa fa-check mr-2"></span>3 spa para mascotas</li>
                                <li><span class="fa fa-check mr-2"></span>5 revisiones medicas</li>
                                <li><span class="fa fa-check mr-2"></span>5 paseos post servicio</li>
                            </ul>
                ...
                <div class="col-md-4 ftco-animate">
                    <div class="block-7">
                        ...
                        <div class="text-center p-4">
                            ...
                            <span class="price"><sup>$</sup> <span class="number">80</span> <sub>/mos</sub></span>

                            <ul class="pricing-text mb-5">
                                <li><span class="fa fa-check mr-2"></span>6 spa para mascotas</li>
                                <li><span class="fa fa-check mr-2"></span>6 revisiones medicas</li>
                                <li><span class="fa fa-check mr-2"></span>6 paseos post servicio</li>
                            </ul>
