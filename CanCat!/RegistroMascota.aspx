                    ...
                    <div class="myform-bottom">
                        <form role="form" action="" method="post" class="" >
                            ...
                            <div class="mb-3"> 
                                ...
                                <asp:TextBox ID="Edad" runat="server" type="number" class="form-control"  onpaste="return false" minlength="3" maxlength="15" onkeypress="return validar(event)"></asp:TextBox> 
                            </div>
                              <div class="mb-3">
